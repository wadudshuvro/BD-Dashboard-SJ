...
-- Fixed version with proper identity provider_id
...
BEGIN
  ...
  IF new_user_id IS NULL THEN
    ...
    -- Insert identity for email auth with proper provider_id
  ...
  RAISE NOTICE 'Successfully created super admin user: Paresh Bagi (%)
  with user_id: %', 'paresh@sjinnovation.com', new_user_id;
END $$;